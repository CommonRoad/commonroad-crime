...
def solver_wttc(veh_1: Obstacle,
    ...
    v_1x0, v_1y0 = veh_1.state_at_time(time_step).velocity * [np.cos(veh_1.state_at_time(time_step).orientation),
                                                              np.sin(veh_1.state_at_time(time_step).orientation)]
    v_2x0, v_2y0 = veh_2.state_at_time(time_step).velocity * [np.cos(veh_2.state_at_time(time_step).orientation),
