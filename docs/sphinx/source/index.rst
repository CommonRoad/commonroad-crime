...
autonomous vehicle, we present the novel CommonRoad **Cr**\iticality
**Me**\asures (CommonRoad-CriMe) toolbox, which:

- provides a framework in Python with unified notations, vehicle models, and coordinate systems for criticality measures;
- adopts and supplements the categorization of criticality measures defined in `here <criticality-metrics.readthedocs.io/>`_;
