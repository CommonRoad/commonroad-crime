...
```
cd existing_repo
git remote add origin https://gitlab.lrz.de/yuanfei/commonroad-criticality-assessment.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.lrz.de/yuanfei/commonroad-criticality-assessment/-/settings/integrations)
